(()=>{
    ...
    return `<section id="aiModeControl" class="panel" style="margin-bottom:14px">
      ...
      <div class="panel-body">
        <div class="autonomy-levels">
          ...
          <div class="level-card ${mode==='autonomous'?'active':''}"><strong>Autónomo</strong><p>Receciona pedidos claros automaticamente. Dúvidas, faltas contraditórias e alterações incertas continuam em Precisa de mim.</p><button class="btn ghost" data-ai-mode="autonomous" style="margin-top:12px">Ativar Autónomo</button></div>
  ...
  function healthView(worker,mode){
    ...
    if(h.code==='ai_budget_reached')return {level:'warn',title:'IA em pausa: limite diário configurado',copy:'O teto diário de análise definido nesta Central foi atingido. A receção de emails e a impressão das encomendas registadas continuam disponíveis. Este aviso não indica o saldo da conta Netlify.',meta:'Consumo protegido',icon:'!'};
